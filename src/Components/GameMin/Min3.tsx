  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center px-3 py-1 bg-gradient-to-b from-green-600 bg-green-400 rounded-lg ">
        ...
        <div className="flex flex-col items-center gap-y-1">
          ...
          <div className="flex items-center space-x-1">
            {`${formatTime(timer).toString().padStart(2, "0")}`
              .split("")
              .map((char, index) => (
                <div
                  key={index}
      ...
      <div className="grid grid-cols-5 gap-4">
       ...
       {/* Actions */}
       <div className="flex flex-wrap justify-between space-y-2 my-4">
        <button className="px-16 rounded-lg border-2 border-green-500 text-red-500">
          Random
        </button>
