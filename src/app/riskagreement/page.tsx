  ...
  return (
     <div className="bg-white flex-1 min-h-screen">
          ...
          <div className="p-5 font-[500] text-gray-500 text-sm flex flex-col gap-3">
            <p>When you visit the Site, we collect certain information about your device, your interaction with the Site, and the information necessary to process your purchases. We may also collect additional information if you may also collect additional information if you</p>
